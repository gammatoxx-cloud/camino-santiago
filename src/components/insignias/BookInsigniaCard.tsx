...
interface BookInsigniaCardProps {
  insignia: BookInsignia;
  isEarned: boolean;
}

export function BookInsigniaCard({ insignia, isEarned }: BookInsigniaCardProps) {
  const requirementText = formatBookRequirement(insignia);
